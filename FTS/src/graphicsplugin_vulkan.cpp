...
// adjust the window size and show at InitDevice time
    ...
    hWnd = CreateWindowW(wc.lpszClassName, L"fts (Vulkan)", WS_OVERLAPPEDWINDOW | WS_VISIBLE, CW_USEDEFAULT, CW_USEDEFAULT,
